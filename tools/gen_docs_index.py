...
META = {
    ...
    "odyssey-link.html": ("How the four images talk",
        ...
        [], "uart"),
    "odyssey-spec.html": ("What the specification contains",
        "Thirteen sections measured, and where the findings cluster",
        [], "gpio"),
    "odyssey-history.html": ("How it got here",
        "Thirty-one revisions in four days, read out of git",
        [], "i2c"),
    "odyssey-findings.html": ("How this went wrong, and what caught it",
        "Eighteen defects found by review, forty-six by building it",
        ["findings-ledger", "findings"], "power"),
