...
[![consistency](https://img.shields.io/badge/consistency_checks-23-blue)](tools/check_consistency.py)
...
**Status:** revision 4.0 — DShot bench procedure ready; the driver awaits its first contact with hardware. All eighteen defects found in the
...
23 checks. `--fix` repairs whitespace, BOM totals and any specification constant that has
