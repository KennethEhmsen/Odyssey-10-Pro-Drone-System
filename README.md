...
[![consistency](https://img.shields.io/badge/consistency_checks-30-blue)](tools/check_consistency.py)
...
30 checks. `--fix` repairs whitespace, BOM totals and any specification constant that has
