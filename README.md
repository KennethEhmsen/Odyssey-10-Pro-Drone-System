...
[![consistency](https://img.shields.io/badge/consistency_checks-28-blue)](tools/check_consistency.py)
...
28 checks. `--fix` repairs whitespace, BOM totals and any specification constant that has
