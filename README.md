...
[![consistency](https://img.shields.io/badge/consistency_checks-31-blue)](tools/check_consistency.py)
...
31 checks. `--fix` repairs whitespace, BOM totals and any specification constant that has
