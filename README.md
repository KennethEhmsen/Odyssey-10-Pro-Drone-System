...
[![consistency](https://img.shields.io/badge/consistency_checks-32-blue)](tools/check_consistency.py)
...
32 checks. `--fix` repairs whitespace, BOM totals and any specification constant that has
