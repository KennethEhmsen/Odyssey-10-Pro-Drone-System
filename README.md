...
[![consistency](https://img.shields.io/badge/consistency_checks-29-blue)](tools/check_consistency.py)
...
29 checks. `--fix` repairs whitespace, BOM totals and any specification constant that has
